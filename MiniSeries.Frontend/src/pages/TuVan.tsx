export default function TuVan() {
  return (
    <div style={{ padding: '60px 20px', textAlign: 'center', minHeight: '80vh', color: '#fff' }}>
      ...
      <p style={{ color: '#94a3b8', marginBottom: '40px' }}>Liên hệ với đội ngũ chuyên gia của chúng tôi để được giải đáp thắc mắc và tư vấn giải pháp tối ưu.</p>
      ...
      <div style={{ 
        ...
        <form onSubmit={(e) => { e.preventDefault(); alert('Đã gửi yêu cầu tư vấn!'); }}>
