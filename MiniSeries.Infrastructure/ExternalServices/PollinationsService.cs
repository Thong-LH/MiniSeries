...
public class PollinationsService : IImageGenerationService, IMangaService, IVideoService, IStorageService
{
    ...
    {
        var videoPrompt = $"Cinematic educational video, {action}, high quality, consistent character: {anchorImageUrl}. Note: If there is any text, dialogue, or subtitles in the video, write it in English.";
